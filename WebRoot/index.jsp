...
<html>
  ...
  <body>
    <form action="/JavaEETask3/doInsert.action" method="post">
    ...
    <form action="/JavaEETask3/doQuery.action" method="post">
    	搜索书目：<input type="text" name="bookId"/><input type="submit" value="搜索">
    </form>
    
    <form action="/JavaEETask3/doUpdate.action" method="post">
